...
return array (
  ...
  'Created Date' => '建立日期',
  'Detail List' => '詳細列表',
  'Expection Date' => '期望完成日',
  'For My Team' => '專案收件匣',
  'How many requied tasks are there to finish this project? At least 4 tasks.' => '需要完成專案的任務數量。',
  'TODO' => '審核中',
  'This department doesn\'t accept the new project now! Try another one.' => '本部門目前不能接受新專案，請試試其它部門。',
  'To Others' => '外發專案匣',
  'is Done/Undone' => '已/未完成',
  'is Published' => '已發佈',
  'Audition'=>'待審專案匣',
  'Auditted'=>'已審核專案匣',
  'Business Items'=>'部門業務項目',
  'Are you sure about deleting [title]?'=>'你確定要刪除業務項目：[title]？',
  '來源處' => '',
  '全球市場處' => '',
  '商品來源部' => '',
  '總管理處' => '',
  ...
  'How many requied tasks are there to finish this project? At least 1 tasks.' => '最少需要1個任務來完成專案',
  ...
  'Actions' => '操作',
  'All...' => '全部...',
  'Anything else you want to say?' => '還要說什麼嗎？',
  'Are you sure about accepting this project? Project:[project_title]. Once accepted, it cannot be reversed!' => '你確定要接受本專案嗎？專案名稱：project_title。一旦接受便覆水難收喔！',
  'Are you sure about declining this project? Project:[project_title]. Once declined, it cannot be reversed!' => '你確定要拒絕本專案嗎？專案名稱：project_title。一旦接受便覆水難收喔！',
  'Are you sure about delete this project? Project:[project_title]. Once deleted, it cannot be reversed!' => '你確定要刪除本專案嗎？專案名稱：project_title。一旦接受便覆水難收喔！',
  'Are you sure about deleting this task?' => '你確定要刪除這項任務嗎？',
  'Are you sure you want to commit? Once you commit, this project is offically running and cannot be stopped.' => '你確定要送出了嗎？一旦送出本任務就進入執行階段，不可回頭喔！',
  'Auditor: name(email)' => '審查人： name(email)',
  'Budget' => '預算',
  'Conatct: {name}' => '聯絡人：{name}',
  'Contact' => '聯絡人',
  ...
  'Department' => '部門',
  'Dept' => '部門',
  'Describe why you need this project.' => '描述本專案的目的',
  'Description' => '描述',
  'Different types have different audit processes.' => '不同專案有不同審核流程',
  'Due Date' => '到期日',
  'Edit' => '編輯',
  'Edit Project::project_title' => '編輯專案::project_title',
  'Estimated Profit' => '預估效益',
  'Expecting' => '預期',
  'Expecting Finish Date' => '預期完成日期',
  'Files' => '檔案',
  'From:' => '來源：',
  'How many departments will be effected by this project?' => '多少部門可受益',
  'How much profit you think this project can produce?' => '你認為本專案可產生的效益',
  'Initial a Project' => '初始化專案',
  'Is Done?' => '已完成',
  'Is Published?' => '已發佈',
  'Login' => '登入',
  'Logout' => '登出',
  ...
  'Not Signed' => '尚未簽核',
  'Note' => '備註',
  'On Going Projects' => '進行中專案',
  'Password' => '密碼',
  'Peripheral' => '微型專案',
  'Please Select...' => '請選擇...',
  'Please fix following problems:' => '請修正下列問題',
  'Plus' => '加',
  'Process' => '流程專案',
  'Project Name' => '專案名稱',
  'Project Type' => '專案類型',
  'Project name cannot duplicate with others! Max: 100 chars; Min: 5 chars.' => '專案名稱不可重複，最多100字，最少5字',
  'Purpose' => '目的',
  'Responsibles' => '負責人',
  'Save' => '儲存',
  'Scope' => '範圍',
  ...
  'Type' => '類型',
  'UnPublished' => '未發佈',
  'Unable to connect to DB:[{db}]' => '無法連線到資料庫:[{db}]',
  'Undone' => '未完成',
  'Username' => '帳號',
  'Verifiers' => '驗收人',
  'View' => '檢視',
  'When do you need this project be done?' => '你為何需要本專案',
  'Who and what will benefit from this project.' => '誰會從本專案受益',
  'Who can help you with verifying this project' => '誰可協助驗收本專案',
  'peripheral' => '微型專案',
  '{n} tasks.' => '{n}個任務',
  '下單區間' => '下單區間',
  '出貨' => '出貨',
