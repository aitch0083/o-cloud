		...
		<table id="GridTable" class="table table-responsive table-condensed table-hover">
			<thead>
				<tr>
					...
					<th><?php Utils::e('Created'); ?></th>
					<th><?php Utils::e('Expecting'); ?></th>
					<th><?php Utils::e('Done?'); ?></th>
					<th><?php Utils::e('Targets'); ?></th>
					<th><?php Utils::e('Scope'); ?></th>
					<th><?php Utils::e('Criterions'); ?></th>
					<th><?php Utils::e('Task'); ?></th>
			...
			<tbody>
				...
				<tr class="target_rec<?php echo $recId; ?>">
					<td><?php echo Utils::eLabel($record['is_published'] ? 'Signed' : 'Not Signed', false); ?></td>
					...
					<td><?php echo substr($record['created'], 0, 10); ?></td>
					<td>
						<?php 
